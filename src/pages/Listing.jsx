...
const Listing = () => {
    ...
    return (
        <main>
            {Boolean(listing?.imgUrls?.length) && <Swiper slidesPerView={1} pagination={{ clickable: true }}>
                {listing.imgUrls.map((imgUrl) => {
                    return <div className='swiperSlideDiv'>{imgUrl}</div>
                }
                )}
            ...
            <div className="listingDetails">
                ...
                <div className="leafletContainer">
                    <MapContainer style={{ height: '100%', width: '100%' }}
                        ...
                        {/* <Marker position={[listing.latitude, listing.longitude]}></Marker> */}
