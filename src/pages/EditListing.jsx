    ...
    const onSubmit = async (e) => {
        try {
            ...
            if (Number(discountedPrice) >= Number(regularPrice)) {
                ...
                console.log(`'discountedPrice' = ${discountedPrice}, 'and', 'regularPrice' = ${regularPrice}`)
                return
            }
            if (images.length > 6) {
                setLoading(false)
            ...
            if (geolocationEnabled) {
                const response = await fetch(`https://api.wikiocity.com/r/search?address=${address}&country=NG&key=2d54af2f92419fcc4506f7bc0`)
                // https://api.wikiocity.com/r/search?search={search string}&country={country}&key={your_api_key}
                ...
                location = address
                // console.log("this is checking the geolocation out: ", geolocation, location)
                    ...
                    <div className="formRooms flex">
                        ...
                        <div>
                            ...
                            <input type="number" className="formInputSmall"
                                id="bathrooms" value={bathrooms} onChange={onMutate} min='1' max='50' required />
                        </div>
                    </div>
                    <label className="formLabel">Parking Spot</label>
                    <div className="formButtons">
                        <button className={parking ? 'formButtonActive' : 'formButton'} type='button' id="parking" value={true} onClick={onMutate} min='1' max='50'>Yes
                        </button>
