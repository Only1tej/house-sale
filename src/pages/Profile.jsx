...
function Profile() {
    ...
    const onDelete = async (listingId) => {
        if (window.confirm('Are you sure you want to delete?')) {
            ...
            // console.log('this is the updated listings', updatedListings); 
                        ...
                        <>
                            ...
                            <ul className="listingsList">
                                {listings.map((listing, index) => (
                                    <ListingItem key={`${index}`} listing={listing.data} id={listing.id} onDelete={() => onDelete(listing.id)} onEdit={(id) => onEdit(id)} />
                                ))}
                            </ul>
                        </>
                    )}
